...
module Pipeline_top(clk, rst);
    ...
    fetch_cycle Fetch (
                        ...
                        // ADDED: freeze PC and IF/ID register during load-use stall
                        .StallF(StallF),
                        .StallD(StallD),

                        // ADDED: flush IF/ID instruction on taken branch/jump
                        .FlushD(FlushD),
...
module Pipeline_top(clk, rst);
    ...
    // ADDED: branch funct3 forwarded to execute stage
    wire [2:0] funct3_E;
    ...
    decode_cycle Decode (
                        ...
                        // ADDED: connect branch type to execute
                        .funct3_E(funct3_E),
    ...
    execute_cycle Execute (
                        ...
                        // ADDED: execute uses funct3 to choose beq/bne/blt/bge/bltu/bgeu
                        .funct3_E(funct3_E),
