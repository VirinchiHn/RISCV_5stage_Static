...
module decode_cycle(clk, rst, InstrD, PCD, PCPlus4D, RegWriteW, RDW, ResultW, RegWriteE, ALUSrcE, MemWriteE, ResultSrcE,
    BranchE, JumpE, JalrE, FlushE, funct3_E, ALUControlE, RD1_E, RD2_E, Imm_Ext_E, RD_E, PCE, PCPlus4E, RS1_E, RS2_E);
    ...
    input FlushE;
    output RegWriteE,ALUSrcE,MemWriteE,BranchE,JumpE,JalrE;
    ...
    wire RegWriteD,ALUSrcD,MemWriteD,BranchD,JumpD,JalrD;
